...
##Pmod Header JA
##Sch name = JA1
#set_property PACKAGE_PIN J1 [get_ports {EN_A}]
#set_property IOSTANDARD LVCMOS33 [get_ports EN_A]
##Sch name = JA2
#set_property PACKAGE_PIN L2 [get_ports {EN_B}]
...
#Sch name = JA7
set_property PACKAGE_PIN H1 [get_ports I1]
set_property IOSTANDARD LVCMOS33 [get_ports I1]
#Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports I2]
set_property IOSTANDARD LVCMOS33 [get_ports I2]
#Sch name = JA9
set_property PACKAGE_PIN H2 [get_ports I3]
set_property IOSTANDARD LVCMOS33 [get_ports I3]
#Sch name = JA10
set_property PACKAGE_PIN G3 [get_ports I4]
...
#Sch name = JC7
#set_property PACKAGE_PIN L17 [get_ports {comparatora}]
#set_property IOSTANDARD LVCMOS33 [get_ports {comparatora}]
##Sch name = JC8
#set_property PACKAGE_PIN M19 [get_ports {comparatorb}]
#set_property IOSTANDARD LVCMOS33 [get_ports {comparatorb}]
##Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {comparatora}]
set_property IOSTANDARD LVCMOS33 [get_ports {comparatora}]
#Sch name = JC10
set_property PACKAGE_PIN R18 [get_ports {comparatorb}]
set_property IOSTANDARD LVCMOS33 [get_ports {comparatorb}]
